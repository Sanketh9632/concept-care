...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Clone the first few cards and append them to the end of the carousel
    const cloneCards = () => {
    ...
    const dragging = (e) => {
        ...
        } else if (newScrollLeft >= carousel.scrollWidth - carousel.offsetWidth) {
