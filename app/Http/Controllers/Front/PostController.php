...
{
    $post_tabs = Tab::all(); // Assuming you have a Tab model
    $accordion_questions = Question::all(); // Assuming you have a Question model

    return view('your-view', compact('post_tabs', 'accordion_questions'));
}
  ...
  public function getServiceDetail($slug = null)
  {
    ...
    return view('front.service-detail', compact('parent_menu_id', 'services', 'dynamic_content', 'post_tabs'));
  }
